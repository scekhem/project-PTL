...
namespace Supercluster.KDTree
{
    ...
    {
        /// <summary>
        /// Gets The number of points in the KDTree
        /// </summary>
        public int Count { get; }

        /// <summary>
        /// Gets The numbers of dimensions that the tree has.
        /// </summary>
        public int Dimensions { get; }

        /// <summary>
        /// Gets The array in which the binary tree is stored. Enumerating this array is a level-order traversal of the tree.
        /// </summary>
        public TDimension[][] InternalPointArray { get; }

        /// <summary>
        /// Gets The array in which the node objects are stored. There is a one-to-one correspondence with this array and the <see cref="InternalPointArray"/>.
        /// </summary>
        public TNode[] InternalNodeArray { get; }

        /// <summary>
        /// Gets or Sets The metric function used to calculate distance between points.
        /// </summary>
        ...
        /// <summary>
        /// Gets The maximum value along any dimension.
        /// </summary>
        private TDimension MaxValue { get; }

        /// <summary>
        /// Gets The minimum value along any dimension.
        /// </summary>
            ...
            double maxSearchRadiusSquared)
        {
            ...
            if (distanceSquaredToTarget.CompareTo(maxSearchRadiusSquared * maxSearchRadiusSquared) <= 0)
            {

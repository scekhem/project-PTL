...
namespace Supercluster.KDTree
{
        ...
        where T : IComparable<T>
    {
        ...
        /// <summary>
        /// Gets or Sets The minimum point of the hyper-rectangle. One can think of this point as the
        ...
        public T[] MinPoint
        {
            ...
            set
            {
                this._minPoint = new T[value.Length];
                value.CopyTo(this._minPoint, 0);
            }
        }

        /// <summary>
        /// Gets or Sets The maximum point of the hyper-rectangle. One can think of this point as the
        ...
        public T[] MaxPoint
        {
            ...
            set
            {
                this._maxPoint = new T[value.Length];
                value.CopyTo(this._maxPoint, 0);
            }
        }
        ...
        public T[] GetClosestPoint(T[] toPoint)
        {
            ...
            {
                if (this._minPoint[dimension].CompareTo(toPoint[dimension]) > 0)
                {
                    closest[dimension] = this._minPoint[dimension];
                }
                else if (this._maxPoint[dimension].CompareTo(toPoint[dimension]) < 0)
                {
                    closest[dimension] = this._maxPoint[dimension];
                }
                else
                {
